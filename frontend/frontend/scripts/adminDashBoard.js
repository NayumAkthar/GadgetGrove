...
navItems.forEach(item => {
  ...
  document.getElementById('addItemForm').addEventListener('submit', async (e) => {
    ...
    try {
      const response = await fetch('https://gadgetgrove-n38v.onrender.com/api/adminfunctions/add-mobile', {
  method: 'POST',
  body: formData
});
      if (response.ok) {
  ...
  window.searchMobile = async function() {
    ...
    try {
     const response = await fetch(`https://gadgetgrove-n38v.onrender.com/api/adminfunctions/search-mobile/${searchTerm}`);
  ...
  document.getElementById('editItemForm').addEventListener('submit', async (e) => {
    ...
    try {
      const response = await fetch(`https://gadgetgrove-n38v.onrender.com/api/adminfunctions/update-mobile`, {
  method: 'PUT',
  ...
  document.getElementById('addSlidesForm').addEventListener('submit', async (e) => {
    ...
    try {
      const response = await fetch('https://gadgetgrove-n38v.onrender.com/api/adminfunctions/add-slide', {
  method: 'POST',
  body: formData
});
...
document.getElementById('editSlideForm').addEventListener('submit', async (e) => {
  ...
  try {
    const response = await fetch(`https://gadgetgrove-n38v.onrender.com/api/adminfunctions/update-slide/${slideId}`, {
      method: 'PUT',
      body: formData
    });
...
async function loadSlides() {
  try {
    const response = await fetch('https://gadgetgrove-n38v.onrender.com/api/adminfunctions/slides');
  ...
  window.deleteSlide = async function(slideId) {
    ...
    try {
      const response = await fetch(`https://gadgetgrove-n38v.onrender.com/api/adminfunctions/delete-slide/${slideId}`, { method: 'DELETE' });
  ...
  document.getElementById('changePasswordForm').addEventListener('submit', async (e) => {
    ...
    try {
     const response = await fetch('https://gadgetgrove-n38v.onrender.com/api/adminfunctions/change-password', {
  method: 'POST',
  headers: { 'Content-Type': 'application/json' },
...
async function loadOrders() {
  try {
    const response = await fetch('https://gadgetgrove-n38v.onrender.com/api/adminfunctions/orders');
...
window.viewOrderDetails = async function(orderId) {
  try {
    const response = await fetch(`https://gadgetgrove-n38v.onrender.com/api/adminfunctions/order/${orderId}`);
