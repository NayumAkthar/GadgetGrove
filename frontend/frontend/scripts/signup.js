...
async function handleSignup(event) {
  ...
  try {
    const response = await fetch('https://gadgetgrove-n38v.onrender.com/api/users/signup', {
      method: 'POST',
...
async function handleLogin(event) {
  ...
  try {
    const response = await fetch('https://gadgetgrove-n38v.onrender.com/api/users/send-otp', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
...
async function handleOtpSubmit(event) {
  ...
  try {
    const response = await fetch('https://gadgetgrove-n38v.onrender.com/api/users/verify-otp', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
